...
const ChampDropDownRight = ({filteredChamps2, onChampClick, listMouseEnter, listMouseLeave, onLiKeyDown}) => {
  ...
  <ul style={{width: '120px', paddingLeft: 0, visibility: 'hidden'}}></ul> )
    : ( 
      ...
      onMouseEnter={listMouseEnter} onMouseLeave={listMouseLeave} tabIndex='0' id='ulRight'>
        { dropDown2 }
      </ul>
    )
};
